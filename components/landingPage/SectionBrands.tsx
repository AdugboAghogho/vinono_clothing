  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4 py-12 rounded-3xl text-center shadow-xl shadow-gray-900/50  overflow-hidden relative">
        <h2 className="text-4xl md:text-5xl font-bold  text-black dark:text-gray-300 mb-12">
          Brands We've Worked With.
        </h2>

        {/* Slider Track */}
        <div className="relative w-full flex">
          <div className="flex w-max animate-marquee-left [animation-duration:30s] md:[animation-duration:40s]">
