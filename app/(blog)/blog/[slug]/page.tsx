  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] pb-24">
      ...
      <header className="container mx-auto px-4 md:px-8 py-6 flex justify-between items-center">
        <Link href="/blog">
          <button className="w-10 h-10 bg-white border border-gray-100 rounded-full flex items-center justify-center shadow-xl shadow-gray-900/50 hover:bg-gray-50 transition-colors">
