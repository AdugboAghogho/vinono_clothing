  ...
  return (
    <ClerkProvider>
      ...
      <html lang="en" suppressHydrationWarning>
        <body
          className={`${inter.className} pb-20 md:pb-0 relative bg-white/80 text-gray-900 dark:bg-[#272727fb] transition-colors duration-300`}
        >
          <ThemeProvider
            attribute="class"
            defaultTheme="light"
          ...
          >
            ...
            <a
              href="https://wa.me/2348107902179?text=Hello%20Vinono%20Clothing!%20I%20would%20like%20to%20make%20an%20inquiry."
              target="_blank"
            ...
            <ThemeToggle className="fixed bottom-40 right-4 md:bottom-28 md:right-8 z-[100]" />
          </ThemeProvider>
        </body>
      </html>
    </ClerkProvider>
